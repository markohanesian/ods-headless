    ...
    <section id="intake-audit" className="px-6 lg:px-12 py-24 bg-zinc-900 dark:bg-zinc-900/60 text-zinc-50 border-t border-zinc-800 scroll-mt-20">
      <div className="max-w-4xl mx-auto">
        <div className="text-center space-y-6 mb-12">
          <div className="inline-block px-3 py-1 label-mono border border-zinc-700 text-accent-blue font-bold">
            OPTION 02 // DYNAMIC STRATEGY AUDIT
          </div>
          
          <h2 className="text-3xl sm:text-5xl font-bold tracking-tighter text-white">
            Want a Comprehensive Operational Audit?
          </h2>
          
          <p className="text-zinc-400 text-lg sm:text-xl font-light max-w-2xl mx-auto leading-relaxed">
            Prefer a structured review? Map out your project scope, launch timeline, and biggest operational bottlenecks so our lead architect can analyze your workflow.
          </p>
          ...
          {!isOpen && (
            <div className="pt-4">
              ...
              >
                <span>Start Your Free 2-Minute Strategy Audit</span>
